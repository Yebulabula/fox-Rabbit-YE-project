...
public class Rabbit extends Animal 
{
    ...
    public void act(List<Animal> newRabbits)
    {
        ...
        if(isAlive()) {
            ...
            //
            //Object Animalfather= get_Father();
            ...
            {
                Object Animalfather = get_Father();
                if(Animalfather instanceof Rabbit)
                {
                    Rabbit father =(Rabbit) Animalfather;
            ...
            {
                if(newLocation == null&&get_children()==null&&get_Couple()==null) { 
    ...
    public Rabbit lowest_Foodlevel()
    {
        int min = 0;
        
        HashMap<Integer,Rabbit> findLevel= new HashMap();
                ...
                if(!rabbit1.getSex().equals(rabbit2.getSex()))
                {
                    ...
                    if(!rabbit1.If_getIll()&&!rabbit2.If_getIll())
                    {
                        for(int b = 0; b < births && free.size() > 0; b++) {
                            ...
                            rabbit1.set_Couple(rabbit2);
                            rabbit2.set_Couple(rabbit1);
