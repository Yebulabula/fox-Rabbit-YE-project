...
public class Simulator
{
    ...
    private static final double COW_CREATION_PROBABILITY= 0.3;
    // The probability that a Grass will be created in any given grid position.
    private static final double GRASS_CREATION_PROBABILITY = 0.43;   
    // The probability that a Tiger will be created in any given grid postion.
    private static final double TIGER_CREATION_PROBABILITY = 0.45;  
    // The probability that a Wolf will be created in any given grid postion.
    private static final double WOLF_CREATION_PROBABILITY=0.3;
