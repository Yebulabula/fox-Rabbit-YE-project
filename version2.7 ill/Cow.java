...
public class Cow extends Animal
{
     ...
     * 类 cow 的对象的构造函数
     */
    public Cow(boolean randomAge,Field field,Location location,String sex,boolean ill)
    {
    ...
    public void act_foggy(List<Animal> newCows)
    {
        incrementAge();
        incrementHunger();
        if(isAlive()) {
            ...
            if(animal1 instanceof Rabbit&&animal2 instanceof Rabbit)
            {
                ...
                if(!cow1.getSex().equals(cow2.getSex()))
                {
                    ...
                    for(int b = 0; b < births && free.size() > 0; b++) {
                        ...
                        Cow  young = new Cow(false, field, loc,"",false);
                        young.getGender();
                        newCows.add(young);
                    }
                }
