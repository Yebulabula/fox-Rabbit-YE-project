...
public class Simulator
{
    ...
    private static final double COW_CREATION_PROBABILITY= 0.05;
    ...
    {
       weather= new Weather();
       currentWeather=weather.random_weather();
    ...
    public void simulateOneStep()
    {
        ...
        else if(step%2==0&&currentWeather.equals("Rainy"))
        {
            for(Iterator<Animal> it = animals.iterator(); it.hasNext(); ) {
                Animal animal = it.next();
                animal.act_night(newAnimals);
        ...
        for(int row = 0; row < field.getDepth(); row++) {
            for(int col = 0; col < field.getWidth(); col++) {
                if(rand.nextDouble() <= FOX_CREATION_PROBABILITY) {
                    ...
                    Location location = new Location(row, col);
                    Grass grass = new Grass(true, field, location,false);
                    plants.add(grass);     
                }
